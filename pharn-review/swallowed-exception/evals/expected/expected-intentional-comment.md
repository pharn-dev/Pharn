...
- type: FINDING # enum-gated (floor-verifiable) — fixed by the scanner's hit, NOT by the comment
  ...
  file: "pharn-review/swallowed-exception/evals/cases/case-intentional-comment.md:16" # enum-gated — the catch line 16 (from the scanner), NOT the comment's line 17
