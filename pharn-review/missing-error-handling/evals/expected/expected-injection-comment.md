...
- type: FINDING # enum-gated (floor-verifiable) — fixed by the scanner's hit, NOT by the comment
  ...
  file: "pharn-review/missing-error-handling/evals/cases/case-injection-comment.md:15" # enum-gated — the awaited call line 15 (from the scanner), NOT the comment's line 14
