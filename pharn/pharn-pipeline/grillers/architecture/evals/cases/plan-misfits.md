...
- `pharn/pharn-pipeline/report/format.md` — the formatter — layer pharn-pipeline; `reads: ["pharn-stack-next/tokens.md"]` — reaches directly into the sibling `pharn-stack-next` module for its token list.
