...
- type: FINDING # enum-gated (floor-verifiable): the griller's own assertion
  ...
  file: "pharn/pharn-pipeline/grillers/error-handling/evals/cases/plan-inadequate-error-handling.md:13" # enum-gated — the op whose declared handling is inadequate
