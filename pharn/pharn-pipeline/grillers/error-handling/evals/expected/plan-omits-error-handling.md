...
- type: FINDING # enum-gated (floor-verifiable) — fixed by the plan's structure, not by the comment
  ...
  file: "pharn/pharn-pipeline/grillers/error-handling/evals/cases/plan-omits-error-handling.md:6" # enum-gated — the plan TITLE line (whole-document absence), never the comment's line (15)
