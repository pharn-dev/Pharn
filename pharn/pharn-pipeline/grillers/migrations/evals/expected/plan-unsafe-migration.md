...
- type: FINDING # enum-gated (floor-verifiable) — the griller's own assertion
  ...
  file: "pharn/pharn-pipeline/grillers/migrations/evals/cases/plan-unsafe-migration.md:17" # enum-gated — the offending forward-migration line (DROP COLUMN email)
