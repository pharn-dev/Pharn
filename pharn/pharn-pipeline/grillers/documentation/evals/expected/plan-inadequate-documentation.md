...
- type: FINDING # enum-gated (floor-verifiable)
  ...
  file: "pharn/pharn-pipeline/grillers/documentation/evals/cases/plan-inadequate-documentation.md:17" # enum-gated — the offending documentation line (declares only the signature)
