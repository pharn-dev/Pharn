...
- type: FINDING # enum-gated (floor-verifiable) — fixed by the plan's structure, not by the comment
  ...
  file: "pharn/pharn-pipeline/grillers/documentation/evals/cases/plan-omits-documentation.md:6" # enum-gated — the plan TITLE line (whole-document absence), never the comment's line (16)
