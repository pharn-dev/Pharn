...
- type: FINDING # enum-gated (floor-verifiable) — the scanner hit is fixed
  ...
  file: "pharn/pharn-review/n-plus-one/evals/cases/case-braceless-map-query.md:13" # enum-gated — the scanner's line (the `db.findMany` call inside the `.map` callback)
